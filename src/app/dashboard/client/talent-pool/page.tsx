...
import { Share2, UserCheck, Star, Eye, Filter } from "lucide-react";
          ...
          {topMatches.map((candidate) => (
            ...
            >
              ...
              <div className="w-full mt-2 sm:mt-auto pt-1 sm:pt-2">
                <Button
                  className="w-full bg-[#009FE3] hover:bg-[#007bbd] text-white font-semibold shadow-md text-xs sm:hidden py-2"
                ...
                <Button
                  className="w-full gap-2 bg-[#009FE3] hover:bg-[#007bbd] text-white font-semibold shadow-md text-base hidden sm:inline-flex py-3"
                  onClick={() => alert(`Request interview with ${candidate.name}`)}
                >
